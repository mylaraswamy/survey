...
class SurveyFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survey_form" do
    assert_difference('SurveyForm.count') do
      post survey_forms_url, params: { survey_form: { description: @survey_form.description, title: @survey_form.title, user_id: @survey_form.user_id } }
    end
  ...
  test "should update survey_form" do
    patch survey_form_url(@survey_form), params: { survey_form: { description: @survey_form.description, title: @survey_form.title, user_id: @survey_form.user_id } }
